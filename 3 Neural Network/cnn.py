...
class CNN(nn.Module):
    ...
    def __init__(self):
        ...
        self.conv = nn.Conv2d(in_channel_size=1, out_channel_size=8, kernel_size=3) # TO DO !!!!!
...
print("Output shape:", out_shape)  # Should be [20, 10]
print("Fully connected layer shape:", fc_shape)  # Should be [10, 8*49*49]